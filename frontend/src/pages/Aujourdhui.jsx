    ...
    <div className="space-y-6" data-testid="page-aujourdhui">
      ...
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div>
          ...
          <p className="text-white/55 text-sm mt-1 max-w-xl">Votre Cap devient une décision concrète, sans perdre de vue votre capacité.</p>
        </div>
      ...
      <div className="glass p-6 grid grid-cols-1 lg:grid-cols-[1fr_auto] gap-6 items-center" data-testid="aujourdhui-hero">
        <div>
          <span className="inline-flex items-center gap-1.5 rounded-full bg-emerald-400/15 border border-emerald-400/25 px-3 py-1 text-[11px] font-semibold text-emerald-300">
            <span className="w-1.5 h-1.5 rounded-full bg-emerald-400" /> {vision?.value ? "Cap actif" : "Cap à définir"}
          </span>
          ...
          <p className="text-white/55 text-sm mt-1 max-w-lg">Le Cap Vivant vous aide à choisir une action réaliste plutôt qu'à remplir une liste.</p>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4" data-testid="aujourdhui-metrics">
        ...
        <div className="glass p-4">
          <p className="text-xs text-white/50">Votre Cap</p>
      ...
      {/* Décision à clarifier + Impact sur le Cap — état honnête, pas de décision fabriquée */}
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        ...
        <div className="glass p-5" data-testid="aujourdhui-cap-link">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="text-[11px] font-semibold uppercase tracking-wide text-blue-300">Impact sur le Cap</span>
          </div>
          ...
          <button onClick={() => navigate("/vision")} className="mt-3 inline-flex items-center gap-1 text-sm text-[#D4AF37] hover:text-[#FFD700] transition-colors">
            Construire mon Cap <ArrowRight size={14} />
          </button>
        </div>
      </div>

      {/* Priorité du jour — détail des vraies tâches, lien vers Mon Mouvement */}
