    ...
    <div className="space-y-5">
      ...
      <div className="grid gap-4 lg:grid-cols-[1.2fr_.8fr]">
        ...
        <div className="glass p-5">
          <div className="flex items-center justify-between"><p className="text-xs font-bold uppercase tracking-[.13em] text-white/62">Pourquoi maintenant ?</p><CircleAlert size={16} className="text-[#F1E2CC]" /></div>
          ...
          <div className="mt-5 grid grid-cols-2 gap-2">
            <div className="rounded-xl border border-white/10 bg-white/[0.035] p-3"><p className="text-[10px] uppercase tracking-wide text-white/60">Signaux</p><p className="mt-1 font-head text-xl font-semibold text-white">—</p></div>
            <div className="rounded-xl border border-white/10 bg-white/[0.035] p-3"><p className="text-[10px] uppercase tracking-wide text-white/60">À valider</p><p className="mt-1 font-head text-xl font-semibold text-white">—</p></div>
          </div>
        </div>
      </div>
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="grid gap-4 lg:grid-cols-[1.1fr_.9fr]">
        <div className="glass p-5">
          <div className="flex items-center justify-between"><div className="flex items-center gap-3"><div className="flex h-10 w-10 items-center justify-center rounded-xl border border-white/14 bg-white/5"><Database size={18} className="text-[#F1E2CC]" /></div><div><h3 className="font-head font-semibold text-white">Aucun CRM connecté</h3><p className="text-xs text-white/62">Dernière synchronisation : —</p></div></div><StatusPill tone="muted">Non connecté</StatusPill></div>
          <div className="mt-5 grid grid-cols-2 gap-3 text-sm"><div className="rounded-xl border border-white/10 bg-white/[0.04] p-3"><p className="text-xs text-white/62">Contacts synchronisés</p><p className="mt-1 font-head text-xl text-white">—</p></div><div className="rounded-xl border border-white/10 bg-white/[0.04] p-3"><p className="text-xs text-white/62">Opportunités CRM</p><p className="mt-1 font-head text-xl text-white">—</p></div></div>
        </div>
        <div className="glass p-5"><p className="text-xs font-bold uppercase tracking-[.13em] text-white/62">Gestion du CRM</p><p className="mt-2 text-sm leading-6 text-white/55">Le choix du CRM, les autorisations et les opérations de connexion sont centralisés dans Paramètres → Intégrations.</p><button onClick={onConfigure} className="mt-4 inline-flex items-center gap-2 rounded-xl border border-[#F1E2CC]/45 bg-[#F1E2CC]/10 px-4 py-2.5 text-sm font-semibold text-[#F4D990]"><Plug size={15} /> Ouvrir Paramètres</button></div>
      </div>
      <SyncNotice />
    </div>
  );
...
function IntelligenceView({ onConfigure }) {
  return (
    <div className="space-y-5">
      ...
      <div className="glass p-5"><div className="flex flex-wrap items-center justify-between gap-3"><div><p className="text-xs font-bold uppercase tracking-[.13em] text-white/62">Sources du Radar</p><p className="mt-1 text-sm text-white/55">Les sources et autorisations se gèrent exclusivement dans Paramètres → Intégrations.</p></div><ShieldCheck size={19} className="text-[#F1E2CC]" /></div><button onClick={onConfigure} className="mt-4 inline-flex items-center gap-2 rounded-xl border border-[#F1E2CC]/45 bg-[#F1E2CC]/10 px-4 py-2.5 text-sm font-semibold text-[#F4D990]"><Plug size={15} /> Gérer les intégrations</button></div>
    </div>
  );
}
