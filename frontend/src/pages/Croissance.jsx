              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
                {g.leads.map((l, i) => (
                  <div key={i} style={{ borderLeft: `2px solid ${g.color}`, paddingLeft: 10 }}>
                    ...
                    <p className="muted" style={{ fontFamily: "'Bricolage Grotesque', sans-serif", fontSize: 13, fontStyle: "italic" }}>« {l.snippet} »</p>
          ...
          <Card key={a.id} tid={`alert-${a.id}`} style={a.hot ? { border: `1px solid ${C.terra}66` } : undefined}>
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 12 }}>
              <div style={{ minWidth: 0 }}>
                ...
                <p className="muted" style={{ fontFamily: "'Bricolage Grotesque', sans-serif", fontSize: 14, margin: "4px 0 0", fontStyle: "italic" }}>« {a.text} »</p>
              </div>
              <div style={{ display: "flex", alignItems: "center", gap: 10, flexShrink: 0 }}>
