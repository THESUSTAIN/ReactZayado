...
export default function Collaborateur() {
  ...
  return (
    <div className="space-y-6" data-testid="page-collaborateur">
      <div>
        <p className="text-[11px] font-semibold uppercase tracking-[.14em] text-[#D4AF37]">Collaborateur Zayado</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[1.4fr_1fr] gap-4">
        <div className="glass p-6">
          <div className="flex items-center gap-2 mb-4">
            ...
            <span className="text-[11px] font-semibold uppercase tracking-wide text-[#D4AF37]">Demande structurée</span>
          </div>
        ...
        <div className="glass p-6">
          <p className="text-[11px] font-semibold uppercase tracking-wide text-[#D4AF37] mb-3">Transparence</p>
      ...
      <section className="glass p-6" data-testid="collaborateur-roadmap">
        <div className="flex items-start gap-3">
          ...
          <div>
            <p className="text-[11px] font-semibold uppercase tracking-[.14em] text-[#D4AF37]">Roadmap d’accompagnement</p>
