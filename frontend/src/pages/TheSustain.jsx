...
export default function TheSustain() {
  return (
    <div className="space-y-6" data-testid="page-thesustain">
      <div>
        <p className="text-[11px] font-semibold uppercase tracking-[.14em] text-[#D4AF37]">TheSustain · Foi & vocation</p>
      ...
      <div className="glass p-6 grid grid-cols-1 lg:grid-cols-[1fr_auto] gap-6 items-center">
        <div>
          <span className="inline-flex items-center gap-1.5 rounded-full bg-white/5 border border-white/15 px-3 py-1 text-[11px] font-semibold text-white/70">
            <span className="w-1.5 h-1.5 rounded-full bg-[#D4AF37]" /> Parcours foi activable
          </span>
        ...
        <HeartHandshake size={44} className="text-[#D4AF37] shrink-0" />
      </div>

      <section className="glass p-6 border border-[#D4AF37]/30" data-testid="thesustain-discernment">
        <div className="flex items-center gap-2 text-[#D4AF37] text-[11px] font-semibold uppercase tracking-[.14em]"><BookOpen size={15} /> Temps de discernement</div>
