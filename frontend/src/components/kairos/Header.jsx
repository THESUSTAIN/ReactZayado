  ...
  return (
    ...
    >
      ...
      <div className="flex flex-1 items-center justify-end gap-1.5 sm:gap-2">
          ...
          <DropdownMenuContent align="end" className="glass-strong w-80 border-white/10 text-offwhite">
            ...
            {actuNonVue && (
              <DropdownMenuItem className="flex cursor-pointer items-start gap-3 py-3 focus:bg-white/10" data-testid="notif-actu"
                onClick={() => { localStorage.setItem("actualite_vue_le", new Date().toISOString().slice(0, 10)); setActuNonVue(false); window.dispatchEvent(new Event("kairos:ouvrir-actu")); }}>
        ...
        <div className="ml-1 flex items-center gap-2 rounded-xl border border-white/10 bg-white/5 py-1 pl-1 pr-3" data-testid="header-profile">
