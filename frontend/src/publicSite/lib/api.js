...
export const SAAS_URL = process.env.REACT_APP_SAAS_URL || "https://app.zayado.net";
export const WP_URL = (process.env.REACT_APP_WP_URL || "https://cms.zayado.net").replace(/\/$/, "");
