...
import Boutique from "@/publicSite/pages/Boutique";
import BoutiqueProduct from "@/publicSite/pages/BoutiqueProduct";
import BoutiqueSearch from "@/publicSite/pages/BoutiqueSearch";
import ShopSeoCategory from "@/publicSite/pages/ShopSeoCategory";
import Favorites from "@/publicSite/pages/Favorites";
import Cart from "@/publicSite/pages/Cart";
import Checkout from "@/publicSite/pages/Checkout";
import Contact from "@/publicSite/pages/Contact";
import Apropos from "@/publicSite/pages/Apropos";
import Tarifs from "@/publicSite/pages/Tarifs";
import FAQ from "@/publicSite/pages/FAQ";
import CGV from "@/publicSite/pages/legal/CGV";
import LivraisonRetours from "@/publicSite/pages/legal/LivraisonRetours";
import Confidentialite from "@/publicSite/pages/legal/Confidentialite";
import MentionsLegales from "@/publicSite/pages/legal/MentionsLegales";
import ConditionsUtilisation from "@/publicSite/pages/legal/ConditionsUtilisation";
import Account from "@/publicSite/pages/Account";
import Blog from "@/publicSite/pages/Blog";
// Legacy pages migrated into PublicBoutique wrapper
import Roadmap from "@/publicSite/pages/legacy/Roadmap";
import ServicesPro from "@/publicSite/pages/legacy/ServicesPro";
import Partenaires from "@/publicSite/pages/legacy/Partenaires";
import Equipe from "@/publicSite/pages/legacy/Equipe";
import Groupement from "@/publicSite/pages/legacy/Groupement";
import DevenirPartenaire from "@/publicSite/pages/legacy/DevenirPartenaire";
import PartenairesRecherche from "@/publicSite/pages/legacy/PartenairesRecherche";
import LanguageSwitcher from "@/publicSite/components/LanguageSwitcher";
import CartDrawer from "@/publicSite/components/CartDrawer";
import CookieBanner from "@/publicSite/components/CookieBanner";
import { ShopNotificationBanner, ShopNotificationModal } from "@/publicSite/components/ShopBroadcast";
import { getFavorites } from "@/publicSite/lib/favorites";
...
export default function PublicBoutique() {
  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ background: "var(--zayado-cream)" }} data-testid="public-boutique-wrapper">
      {(!path.startsWith("/boutique/") || path === "/boutique/recherche") && <Helmet>
        <title>{path === "/boutique/recherche" ? "Recherche produits | Boutique ZAYADO" : "Boutique ZAYADO | Outils pour travailler mieux et préserver son énergie"}</title>
        <meta name="description" content="Découvrez la sélection ZAYADO : ergonomie, confort visuel, rituels, concentration et outils pensés pour les indépendants et petites structures." />
