...
import LegalLayout from "@/publicSite/components/LegalLayout";
...
export default function Confidentialite() {
  return (
    <LegalLayout title="Politique de confidentialité" lastUpdate="mai 2026" testId="page-confidentialite">
