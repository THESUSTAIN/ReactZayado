...
export default function Tarifs() {
  ...
  const checkout = async (plan) => {
    ...
    if (!user) {
      navigate(`/login?next=/app/tarifs`);
      return;
    }
    setLoading(plan.id);
    try {
  ...
  return (
    <div className="space-y-10" data-testid="tarifs-page">
      <Helmet>
        ...
        <meta name="description" content="Découvrez les tarifs transparents de Zayado : plan gratuit, Pro et Business pour entrepreneurs et solopreneurs. IA copilote, Growth Agent, pilotage financier. Sans engagement." />
        ...
        <meta property="og:description" content="Plan gratuit, Pro et Business pour solopreneurs. IA copilote, Growth Agent, pilotage financier. Sans engagement." />
        ...
        <script type="application/ld+json">{JSON.stringify({
          ...
          "description": "Plateforme IA tout-en-un pour solopreneurs : copilote IA, Growth Agent, pilotage financier.",
      ...
      <header className="text-center max-w-3xl mx-auto pt-2">
        ...
        <h1 className="font-display text-4xl md:text-5xl italic mb-4">Tarifs transparents et sans surprise</h1>
        <p className="text-[var(--zayado-muted)]">
          Paiement Mollie · CB · SEPA · PayPal · API Claude incluse · Sans engagement
        </p>
        {data.mode === "test" && (
      ...
      <section className="pt-4" data-testid="services-section">
        <header className="text-center mb-6">
          <h2 className="font-display text-3xl italic mb-2">Prestations complémentaires</h2>
          <p className="text-sm text-[var(--zayado-muted)]">Setup, formation, accompagnement — réservez en un clic.</p>
        </header>
