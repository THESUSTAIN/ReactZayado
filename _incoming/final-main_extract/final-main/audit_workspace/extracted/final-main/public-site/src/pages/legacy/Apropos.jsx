    ...
    <div className="max-w-[1100px] mx-auto px-4 md:px-6 py-12" data-testid="apropos-page">
      <section className="text-center mb-16">
        ...
        <p className="text-base md:text-xl max-w-2xl mx-auto leading-relaxed" style={{ color: MUTED }}>
          Zayado est né d'un constat simple : <em>la performance ne devrait pas se faire au détriment du calme.</em>
          Nous accompagnons les entrepreneurs et leurs équipes à construire leur trajectoire avec lucidité.
        </p>
      </section>
      ...
      <section className="text-center p-8 md:p-12 rounded-2xl text-white" style={{ background: NAVY }}>
        ...
        <div className="flex flex-wrap gap-2 justify-center mt-6">
          ...
          <Link to="/login" className="px-5 py-2.5 rounded-full border border-white/40 font-medium text-sm hover:bg-white/10">
            Essayer Zayado SaaS
          </Link>
        </div>
      </section>
