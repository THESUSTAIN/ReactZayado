...
function SEOHead() {
  ...
  const description =
    "ZAYADO est l'alliance unique entre l'extension technologique de votre business par MyExtension AI (70%) et une collaboration humaine axée sur la performance, l'intégrité et le respect (30%). Pilotez votre activité en restant fidèle à vos valeurs profondes.";
