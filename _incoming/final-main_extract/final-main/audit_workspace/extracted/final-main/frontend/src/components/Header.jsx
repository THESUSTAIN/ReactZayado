  ...
  return (
    <header className="app-header" data-testid="app-header">
      ...
      <div className="header-actions">
        ...
        {/* Focus Mode — bascule l'écran d'inspiration plein écran (rituel du matin)
            à la demande. Dispatche l'event global `zayado:show-inspiration`
            capté par App.js qui pilote InspirationScreen. */}
        <button
          className="header-icon-btn"
          title="Mode Focus — rituel du matin"
          aria-label="Mode Focus — écran d'inspiration"
          data-testid="header-focus-btn"
